...
import MEDMEX.Modules.Render.Nametags;
...
public abstract class RenderLiving extends Render {
	...
	public static float var10, var11, var12;
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
		...
		try {
			if(par1EntityLiving.getEntityName().contains(Minecraft.theMinecraft.thePlayer.username)) {
        		if(EntityClientPlayerMP.rotationoverride) {
        			...
        			var10 = this.interpolateRotation(par1EntityLiving.prevRenderYawOffset, par1EntityLiving.renderYawOffset, par9);
                    var11 = this.interpolateRotation(par1EntityLiving.prevRotationYawHead, par1EntityLiving.rotationYawHead, par9);
        		}
        	}else {
            var10 = this.interpolateRotation(par1EntityLiving.prevRenderYawOffset, par1EntityLiving.renderYawOffset, par9);
            var11 = this.interpolateRotation(par1EntityLiving.prevRotationYawHead, par1EntityLiving.rotationYawHead, par9);
			 ...
			 if(par1EntityLiving.getEntityName().contains(Minecraft.theMinecraft.thePlayer.username)) {
	            	if(EntityClientPlayerMP.rotationoverride) {
	            		var12 = EntityClientPlayerMP.custompitch;
	            	}else {
	            		var12 = par1EntityLiving.prevRotationPitch + (par1EntityLiving.rotationPitch - par1EntityLiving.prevRotationPitch) * par9;
	            	}
	            }else {
	            	var12 = par1EntityLiving.prevRotationPitch + (par1EntityLiving.rotationPitch - par1EntityLiving.prevRotationPitch) * par9;
	            }
	...
	protected void passSpecialRender(EntityLiving par1EntityLiving, double par2, double par4, double par6) {
		if(Nametags.instance.isEnabled())
        	if (par1EntityLiving instanceof EntityPlayer || Nametags.instance.AnimalTags)
        		return;

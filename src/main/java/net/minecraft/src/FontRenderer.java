...
public class FontRenderer {
	 ...
	 */
	public int drawStringWithShadow(String par1Str, double par2, double par3, int par4) {
	 ...
	 */
	public int drawString(String par1Str, double par2, double par3, int par4) {
	 ...
	 */
	public int drawString(String par1Str, double par2, double par3, int par4, boolean par5) {
		this.resetStyles();
	 ...
	 */
	private int renderString(String par1Str, double par2, double par3, int par4, boolean par5) {
		if (par1Str == null) {
			return 0;
		} else {
			if ((par4 & -67108864) == 0) {
	...
	public void drawCenteredString(FontRenderer par1FontRenderer, String par2Str, float par3, float par4, int par5)
    {

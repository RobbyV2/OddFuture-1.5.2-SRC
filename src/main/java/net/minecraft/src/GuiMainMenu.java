...
public class GuiMainMenu extends GuiScreen {
	...
	public GuiMainMenu() {
		...
		this.field_92025_p = EaglerAdapter._wisWebGL() ? ("OddFuture by MEDMEX ported to web by 29") : ("OddFuture by MEDMEX ported to web by 29");
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		this.drawString(this.fontRenderer, "OddFuture", 2, this.height - 10, 16777215);

		//String var10 = "Copyright " + Calendar.getInstance().get(Calendar.YEAR) + " Mojang AB.";
		String var10 = "copyright MEDMEX";
